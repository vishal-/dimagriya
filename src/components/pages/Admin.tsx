        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Link to="/admin/assessments" className="block">
            <div className="bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 border border-gray-700/50 group">
              ...
              <p className="text-gray-400 leading-relaxed">
                Create, edit, and manage assessments for students. Upload
                JSON-based question sets and organize them by grade and subject.
              </p>
            </div>
          </Link>
          ...
          <Link to="/admin/answers" className="block mt-5">
            <div className="bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 border border-gray-700/50 group">
              ...
              <p className="text-gray-400 leading-relaxed">
                View correct answers for all assessments. Access answer keys
                organized by question number and section.
              </p>
            </div>
          </Link>

          <Link to="/admin/results" className="block mt-5">
            <div className="bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 border border-gray-700/50 group">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gradient-to-r from-blue-600 to-purple-500 rounded-xl flex items-center justify-center mr-4">
                  <svg
                    className="w-6 h-6 text-white"
                    fill="none"
                    stroke="currentColor"
              ...
              <p className="text-gray-400 leading-relaxed">
                View student assessment attempts and results. Monitor
                performance, track completion rates, and access detailed result
                analysis.
              </p>
            </div>
          </Link>
